...
Gene Expression Graph is a tool made for [BlueGenes](http://bluegenes.apps.intermine.org) following BlueGenes Tool API.
...
1. Clone the repo
2. `cd bluegenes-tool-geneexpression-graph` and then `npm install` to install dependencies.
